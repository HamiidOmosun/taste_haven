    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh]'>
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='text-xl sm:text-2xl my-3'>
            <Title text1={'DELIVERY'} text2={'INFROMARTION'}/>
        </div>
        ...
        <input className='border border-gray-300 py-1.5 px-3.5 w-full rounded' type="email" placeholder='Email Addres'/>
        <input className='border border-gray-300 py-1.5 px-3.5 w-full rounded' type="text" placeholder='Street Address'/>
        <div className='flex gap-3'>
        ...
        <div className='flex gap-3'>
            <input className='border border-gray-300 py-1.5 px-3.5 w-full rounded' type="number" placeholder='Zip code'/>
